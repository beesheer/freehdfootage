$(function(){
    ...
    $('#portal-nav-portals a').attr('href', '/client/review-portal');
    ...
    $('.activatePortal').bind('click', function(){
        ...
        $('#portal-nav-pages a').attr('href', '/client/review-portal/pages/id/' + pId);
        $('#portal-nav-comments a').attr('href', '/client/review-portal/comments/id/' + pId);
    });
